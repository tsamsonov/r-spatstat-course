...
```{r setup-gwr, echo = FALSE, purl = FALSE, include=FALSE}
...
```{r, fig.cap="Весовая функция", echo=FALSE}
...
```{r, fig.cap="Фиксированная весовая функция", echo=FALSE}
...
```{r, fig.cap="Адаптивная весовая функция", echo=FALSE}
